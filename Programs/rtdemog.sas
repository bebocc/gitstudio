...
proc report data=final headline headskip nowindows split='|' missing spacing=1 style(header)=[protectspecialchars=off];
  ...
  define firstcol /" " style={just=l cellwidth=8%};
  define text/ " " style={just=l cellwidth=12%};
  define trt1 / "     0 - 2 |     (N=&pop1)" style={cellwidth=13% asis=on};
  define trt2 / "     3 - 6 |     (N=&pop2)" style={cellwidth=13% asis=on};
  define trt3 / "     7 - 11 |     (N=&pop3)" style={cellwidth=13% asis=on};
  define trt4 / "     12 - &up_limit |     (N=&pop4)" style={cellwidth=13% asis=on};
  define trt5 / "     3 - &up_limit   Total |     (N=&pop5)" style={cellwidth=13% asis=on};
  define trt6 / "     Total |     (N=&pop6)" style={cellwidth=13% asis=on};
